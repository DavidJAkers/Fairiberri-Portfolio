  ...
  return (
    <div className="character_design">
      ...
      <div className="character_design-gallery">
        ...
        <img src="images/character_design/ollie no text.png" alt="ollie" />
        <img
          src="images/character_design/terran bio no text.png"
          alt="terran"
        />
        <img src="images/character_design/ginko.png" alt="ginko" />
      </div>
    </div>
  );
}
